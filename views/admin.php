                    ...
                    <tbody>
                        <?php if($threads): ?>
                            <?php foreach ($threads as $thread): ?>
                                <tr>
                                    <td><a href="/admin/threads/<?=$thread["id"]?>/edit"><?=$thread["name"]?></a></td>
                                    <td><a href="/admin/threads/<?=$thread["id"]?>/edit"><?=$thread["description"]?></a></td>
                        ...
                        <?php if($contacts): ?>
                            <?php foreach ($contacts as $contact): ?>
                                <tr>
                                    ...
                                    <td><a href="/admin/contacts/<?=$contact["id"]?>/edit"><?=$contact["message"]?></a></td>
                                    <td><?=$contact["email"]?></td>
